...
class World:
    def __init__(self, name: str, regions: list[Region], cities: list[City]):
        self.name = name
        self.regions = regions
        self.cities = cities
        self.events = []
        self.players = []  # Track all players in the world

    def log_event(self, event_type: str, details: dict):
        """
        Logs an event in the world and automatically checks quests for progress.
        """
...
class Character:
    ...
    def unlock_achievement(self, achievement_name: str):
        if achievement_name not in self.achievements:
            ...
            print()
    def interact_with_world(self, world: World, event_type: str, details: dict):
        world.log_event(event_type, details)

    def travel_to_region(self, world: World, region: Region):
        self.position = region
        print(f"{self.name} traveled to {region.name}.")
        world.log_event("visit_region", {"region_name": region.name})
